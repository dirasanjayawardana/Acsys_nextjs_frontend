    ...
    const handleSearch = async () => {
        try {
            const response = await axios.post(
                ...
                {
                    kodePos:
                        serachInputCategory === "kodepos" ? searchInput : "",
                    desa: serachInputCategory === "desa" ? searchInput : "",
                    kecamatan:
                        serachInputCategory === "kecamatan" ? searchInput : "",
                    kotaKabupaten:
                        serachInputCategory === "kotaKabupaten"
                            ? searchInput
                            : "",
                    provinsi:
                        serachInputCategory === "provinsi" ? searchInput : "",
                }
            );
        ...
        <div>
            <div className="flex justify-between items-center mt-5">
                <div className="flex items-center w-full gap-2">
                    ...
                    <ButtonAddParameter
                        link={"/main/parameters/kodepos/edit/create"}
                    />
                </div>
