    ...
    <div>
      ...
      <form className="">
        <div className="mt-3 p-4 grid xl:grid-cols-3 gap-3">
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Saldo Minimum Tidak Aktif</label>
            <input
              type="text"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Jumlah Hari Jadi Tidak Aktif</label>
            <input
              type="text"
              placeholder="Saldo Minimum Tidak Aktif"
              className="input input-sm input-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Param Saldo Tidak Aktif</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Override Biaya Penutupan</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Blokir Debet Internal</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Blokir Debet Eksternal</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Blokir Kredit Internal</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Blokir Kredit Eksternal</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Biaya Saldo Minimum</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Biaya Rekening Dormant</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Jumlah Hari Tutup Otomatis</label>
            <input
              type="text"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Tutup Otomatis Dormant</label>
            <select
              className="select select-sm select-bordered w-[220px]"
          ...
          <div className="flex gap-3 items-center">
            <label className="w-[220px]">Is Override Biaya ATM</label>
            <select
              className="select select-sm select-bordered w-[220px]"
